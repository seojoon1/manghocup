...
> ⚠️ **이 저장소는 프론트엔드(웹)만 포함합니다.**
> 선수 불러오기·입찰·채팅이 동작하려면 **백엔드 서버**와 **디스코드 봇**을 함께 실행해야 합니다.
>
> - 백엔드: [`https://github.com/seojoon1/MHC-BE`](<백엔드 저장소 링크>)
> - 디스코드 봇: [`https://github.com/seojoon1/seojoon1Bot`](<디스코드 봇 저장소 링크>)
>
> 세 구성 요소(웹 · 백엔드 · 디스코드 봇)가 모두 실행 중이어야 정상 동작합니다.
...
> 선수 불러오기·입찰·채팅이 동작하려면 **백엔드 서버**와 **디스코드 봇**이 함께 실행 중이어야 한다.
> 각 저장소의 README를 참고해 함께 띄워야 한다.
>
> - 백엔드: [`https://github.com/seojoon1/MHC-BE`](<백엔드 저장소 링크>)
> - 디스코드 봇: [`https://github.com/seojoon1/seojoon1Bot`](<디스코드 봇 저장소 링크>)
